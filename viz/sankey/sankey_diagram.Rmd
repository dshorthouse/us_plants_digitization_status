...
gbif_comp_data <- read_csv("../../gbif_idigbio_comparisons/uniqueToGBIF.csv/2020-12-06.csv")

idigbio_comp_data <- read_csv("../../gbif_idigbio_comparisons/uniqueToiDigBio.csv/2020-12-06.csv")

common_comp_data <- read_csv("../../gbif_idigbio_comparisons/commonToGBIFiDigBio.csv/2020-12-06.csv")
...
#### Calculate percentages for use in the paper!

```{r}

# % digitially available
((sankey_sums$total_num_specimens - total_unknown)/sankey_sums$total_num_specimens)*100

# % digitially available GBIF
(total_gbif / sankey_sums$total_num_specimens)*100

# % digitially available iDigBio
(total_idigbio / sankey_sums$total_num_specimens)*100
